...
# 加载数据
file_path = 'simulator/test_predictions_comparison_lstm.csv'
...
for index, row in data.iterrows():
    ...
    elif row['Forecast'] == 2 and stocks > 0:  # Sell condition
...
data_with_trades = pd.read_csv('simulator/lstm_prediction_with_trades.csv')
